...
import com.morales.apps.eventhandlers.GuessButtonListener;
import com.morales.apps.lifecyclehelpers.QuizViewModel;
...
public class MainActivityFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_main_msmm, container, false);
        ...
        this.shakeAnimation = AnimationUtils.loadAnimation(getActivity(), R.anim.incorrect_shake_msmm);
